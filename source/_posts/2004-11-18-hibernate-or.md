...
<p>[ target="_blank" class="extlink">XDoclet - @hibernate.class (0..1)](http://xdoclet.sourceforge.net/xdoclet/tags/hibernate-tags.html#@hibernate_class__0__1_)</p>
</dd>
...
<p>[ target="_blank" class="extlink">XDoclet - @hibernate.id (0..1)](http://xdoclet.sourceforge.net/xdoclet/tags/hibernate-tags.html#@hibernate_id__0__1_)</p></dd>
<dt>@hibernate.property (XDoclet タグ)</dt>
<dd><p>そのプロパティをテーブルのカラムとマッピングするときに使用するタグ。メソッド宣言の JavaDoc コメントに書く。</p>

<h4>[参考]</h4>

<p>[ target="_blank" class="extlink">XDoclet - @hibernate.property (0..1)](http://xdoclet.sourceforge.net/xdoclet/tags/hibernate-tags.html#@hibernate_property__0__1_)</p></dd>
<dt>カスケード (cascade)</dt>
...
<p>『[ target="_blank" class="extlink">WEB-DB Press 18号](http://www.amazon.co.jp/exec/obidos/ASIN/4774119016/sorehabooks-22)』</p></dd>
<dt>遅延ロード</dt>
...
<p>[ target="_blank" class="extlink">Hibernate.org - Open Session in View](http://www.hibernate.org/Documentation/OpenSessionInView/)</p></dd>
<dt>generator</dt>
