...
[ target="_blank"><img src="http://www.uportal.org/images/uportal-head.gif" style="margin:15px;" border="0" alt="uPortal" />](http://www.uportal.org/)
...
[参考]
+ [ target="_blank">uPortal Home Page](http://www.uportal.org/)<img src="/images/linkext.gif" alt="linkext" />
+ [ target="_blank">uPortal Wiki](http://www.ja-sig.org/wiki/homepage.action)<img src="/images/linkext.gif" alt="linkext" />
+ [ target="_blank">Beginners Guide to uPortal](http://www.fair-portal.hull.ac.uk/downloads/uPortalGuide1.pdf)<img src="/images/linkext.gif" alt="linkext" /> (PDF)
...
<h4>ソースコードをダウンロードする</h4>　[ target="_blank">uPortal](http://www.uportal.org/)<img src="/images/linkext.gif" /> のサイトからソースコードをダウンロードします。
...
<h3>ポータルの実装</h3>　uPortal はポータル実装に [ target="_blank">Pluto](http://jakarta.apache.org/pluto/)<img src="/images/linkext.gif" /> を使っています。Pluto は、Servlet コンテキストのクロスコンテキストが有効でないと機能しません。
